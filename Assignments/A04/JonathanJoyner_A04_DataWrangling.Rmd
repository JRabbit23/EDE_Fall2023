...
select(EPA1, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
select(EPA2, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
select(EPA3, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
select(EPA4, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
write.csv(EPA1, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2018_processed.csv")
write.csv(EPA2, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2019_processed.csv")
write.csv(EPA3, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2018_processed.csv")
write.csv(EPA4, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2019_processed.csv")
```
...
colnames(EPA3)
colnames(EPA4)
# use rename function and pipes to change differing column title to a matching title
EPA1 <- EPA1 %>% 
                rename(
...
EPA_Combined <- rbind(EPA1,EPA2,EPA3,EPA4)
...
EPA_Combined_F1 <-
  EPA_Combined %>%
    ...
    summarize(meanAQI=mean(DAILY_AQI_VALUE), #Create columns for mean of AQI, latitude and longitude
              ...
              Month=month(Date), #Create columns for month and year using lubridate
              Year=year(Date)
              )
#9
EPA_Combined_F1_Spread <- pivot_wider(EPA_Combined_F1, names_from = ozone, values_from = PM2.5)
#10
