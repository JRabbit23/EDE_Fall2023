...
#9 spread the DAILY_AQI_VALUE data into two columns which are PM2.5 and Ozone
EPA_Combined_Spread <- pivot_wider(EPA_Combined,names_from="AQS_PARAMETER_DESC",values_from="DAILY_AQI_VALUE")
