...
library(tidyverse)
#import and name Litter + Neonics datasets from Data/Raw folder
...
#Use dim() to find dimensions of Litter and Neonics datasets
dim(Litter)
dim(Neonics)
#Litter is 188 rows x 19 columns and Neonics is 4623 rows x 30 columns
```
