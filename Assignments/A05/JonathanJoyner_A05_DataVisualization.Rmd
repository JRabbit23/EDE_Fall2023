...
Plot5a<- ggplot(PeterPaul,aes(x = factor(month,levels=1:12,labels=month.abb), y = temperature_C, color=lakename))+
  geom_boxplot() +
  labs(y="Tempereature",x="") +
  theme(legend.position ="bottom")
print(Plot5a)
#create boxplot by TP
Plot5b<- ggplot(PeterPaul,aes(x = factor(month,levels=1:12,labels=month.abb), y = temperature_C, color=lakename))+
  geom_boxplot() +
  labs(y="TP",x="") +
  theme(legend.position ="bottom")
print(Plot5b)
#create boxplot by TN
Plot5c<- ggplot(PeterPaul,aes(x = factor(month,levels=1:12,labels=month.abb), y = temperature_C, color=lakename))+
  geom_boxplot() +
  labs(y="TN",x="") +
  theme(legend.position ="bottom")
print(Plot5c)
...
#7
Plot7 <-
  ggplot(NIWOTNeedles,aes(x = collectDate, y = dryMass)) +
  geom_point() +
