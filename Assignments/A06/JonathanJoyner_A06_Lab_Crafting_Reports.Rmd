...
```{r project.setup, echo=TRUE, error=FALSE, message=FALSE,results="hide"}
#Import libraries
...
\newpage
```{r data.summary, echo=FALSE, eval=TRUE, results="asis"}
...
```{r,eval=TRUE,echo=FALSE,warning=FALSE,fig.width=8,fig.height=4,fig.align="left",fig.cap="OZONE Levels by Month 2018"}
#set theme
mytheme <- theme_classic(base_size = 14)
theme_set(mytheme)
#Fix Date Column
epa_data$Date=ymd(epa_data$Date)
#create Ozone 2018 boxplot
Ozone_2018 <-
  epa_data %>%
    filter(Year==2018) %>%
      ggplot(
...
```{r,eval=TRUE,echo=FALSE,warning=FALSE,fig.width=8,fig.height=4,fig.align="left",fig.cap="OZONE Levels by Month 2019"}
#create Ozone 2019 boxplot
Ozone_2019 <-
  epa_data %>%
    filter(Year==2019) %>%
      ggplot(
...
https://github.com/JRabbit23/EDE_Fall2023/tree/main/Assignments/A06
