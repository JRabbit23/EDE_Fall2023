...
BR_TS_Rain<-ts(BR_complete$Rainfall,start=c(1901-01-01),frequency=12)
BR_TS_Temp<-ts(BR_complete$Temperature_C,start=c(1901-01-01),frequency=12)
...
Rain_STL<-stl(BR_TS_Rain, s.window = "periodic")
plot(Rain_STL)
Temp_STL<-stl(BR_TS_Temp, s.window = "periodic")
plot(Temp_STL)
