...
Ex1a<-
  ggplot(
    EPAair,aes(x=Ozone,fill=Year))+
  geom_density(alpha=0.5)+
  scale_fill_manual(values=c("darkgreen","darkblue"))+labs(
    x="Ozone AQI value",
    y="Density",
    fill="Year")
#print(Ex1a)
...
Pm2.5byOzone.regression <- lm(data = EPAair,
                              PM2.5 ~ Ozone)
...
corrplott.mixed(EPAairCorr,upper="ellipse")
...
OzonebyAll.regression <- lm(data =EPAair.subset,PM2.5 ~ Ozone)
