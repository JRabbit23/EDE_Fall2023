...
huc8_sf <- st_read(here(
  'Data/Spatial/NCHUC8.shp'), stringsAsFactors = TRUE)
...
NeuseSF <- 
  st_read(here('Data/Spatial/NCHUC8.shp')) %>%
...
ggplot() +
  ...
  geom_sf(data=NeuseSF, fill="purple")

mapview(huc8_sf,col.region = "orange") +
  mapview(NeuseSF,col.region="purple")
